<?php
  ...
  Route::prefix('api/v1') -> group(function(){
    ...
    Route::get('search-products/{branch}/{model}/{shipowner}/{filter1?}/{value1?}/{filter2?}/{value2?}/{filter3?}/{value3?}', 'Loftonti\Erso\Controllers\ProductsApiController@searchCars');
